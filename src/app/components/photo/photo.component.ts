    ...
    saveImage() {
        navigator.geolocation.getCurrentPosition((geo) => {
            if (this.platform.is('cordova')) {
                ...
                this.eventsService.newImageAdded(new AppImage(turl, this.imageDesc.value, geo));
            }else{
                this.eventsService.newImageAdded(new AppImage(this.capturedPicture, this.imageDesc.value, geo));
            }
